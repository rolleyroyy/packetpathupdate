        ...
        <div class="container" style="padding-top: 0px; margin-bottom: -12px;">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active " href="aboutus.html"><strong>ABOUT US</strong> </a></li>
    ...
    <main class="page landing-page">
        ...
        <section class="clean-block clean-services ">
           ...
           <div class="row">
            ...
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/fHntBdQsVvY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
           </div>
           </div>
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 d-table h-100">
                        <img class="border-10 rounded border-primary img-fluid align-middle" src="assets/img/relationships.jpg">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="text-center row">
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <center> <img src="assets/img/responsibility.jpg" class="img-fluid"></center>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <center> <img src="assets/img/ideas-market.jpg" class="img-fluid"></center>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <center> <img src="assets/img/work-fun.jpg" class="img-fluid"></center>
