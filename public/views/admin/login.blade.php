...
<head>
    ...
    <link rel="stylesheet" href="{{asset('packetp_site2-main/site/assets/css/smoothproducts.css')}}">
...
<body>
        ...
        <div class="container" style="padding-top: 0px; margin-bottom: -12px;">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="index.html"><strong>Home</strong></a></li>
            ...
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item  active ">
                        <img src="assets/slider/slider-desk-2.jpg" alt="" class="img-fluid">
                    </div>

                    <div class="carousel-item  ">
                        <img src="assets/slider/slider-desk-1.jpg" alt="" class="img-fluid">
                    </div>

                    <div class="carousel-item">
                        <img src="assets/slider/slider-desk-3.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="carousel-item">
                        <img src="assets/slider/slider-desk-4.jpg" alt="" class="img-fluid">
                    </div>
            ...
            <div id="demom" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item align-items-center">
                        <img src="assets/slider/slider-mob-2.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="carousel-item  active ">
                        <img src="assets/slider/slider-mob-1.jpg" alt="" class="img-fluid">
                    </div>

                    <div class="carousel-item">
                        <img src="assets/slider/slider-mob-3.jpg" alt="" class="img-fluid">
                    </div>
                    <!--<div class="carousel-item">
            ...
            <div class="container ">
                ...
                <div class="row">
                    <div class="text-center col-lg-4 col-md-12 col-sm-12">
                        <img src="assets/img/iotp.jpg" class="img-fluid" />
                    ...
                    <div class="text-center col-lg-4 col-md-12 col-sm-12">
                        <img src="assets/img/esp.jpg" class="img-fluid" />
                    ...
                    <div class="text-center col-lg-4 col-md-12 col-sm-12">
                        <img src="assets/img/aiml.jpg" class="img-fluid" />
        ...
        <section class="clean-block slider dark" style="background-color: rgb(255,255,255);">
            <div class="container">
                <div class="customer-logos">
                    <div class="slide"><img src="assets/img/nxp.jpg"></div>
                    <div class="slide"><img src="assets/img/st.jpg"></div>
                    <div class="slide"><img src="assets/img/idevices.jpg"></div>
                    <div class="slide"><img src="assets/img/silkid.jpg"></div>

                    <div class="slide"><img src="assets/img/espressif.jpg"></div>
                    <div class="slide"><img src="assets/img/wiced.jpg"></div>
                ...
                <div class="row" style="text-align: center; padding-top: 40px;">
                    <div class="row">
                        <div class="text-center col-lg-6 col-md-12 col-sm-12">
                            <img class="img-fluid" src="assets/img/microwave.jpg">
                        ...
                        <div class="text-center col-lg-6 col-md-12 col-sm-12">
                            <img class="img-fluid" src="assets/img/air.jpg">
                        ...
                        <div class="text-center col-lg-6 col-md-12 col-sm-12">
                            <img class="img-fluid" src="assets/img/switch.jpg">
                        ...
                        <div class="text-center col-lg-6 col-md-12 col-sm-12">
                            <img class="img-fluid" src="assets/img/alexa.jpg">
    ...
    <script src="{{asset('packetp_site2-main/site/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('packetp_site2-main/site/assets/bootstrap/js/bootstrap.min.js')}}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/baguettebox.js/1.10.0/baguetteBox.min.js"></script>
    <script src="{{asset('packetp_site2-main/site/assets/js/smoothproducts.min.js')}}"></script>
    <script src="{{asset('packetp_site2-main/site/assets/js/theme.js')}}"></script>
    <script src="{{asset('packetp_site2-main/site/assets/js/Client-Slider-1.js')}}"></script>
