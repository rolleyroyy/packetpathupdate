        ...
        <div class="container" style="padding-top: 0px; margin-bottom: -12px;">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="service-page.html"><strong>SERVICES</strong></a></li>
    ...
    <main class="page service-page">
        ...
        <section class="clean-block clean-services dark" style="background-color: rgb(255,255,255);" >
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center"><img class="img-fluid" src="assets/img/iot-consulting.jpg"></div>
        ...
        <section class="clean-block clean-services dark" style="background-color: rgb(246,246,246);"  >
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center d-lg-none"><img class="img-fluid" src="assets/img/firmware-engineering.jpg"></div>
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center">
                    ...
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center"><img class="img-fluid d-none d-lg-block" src="assets/img/firmware-engineering.jpg"></div>
                </div>
            </div>
        </section>
        <section class="clean-block clean-services dark " style="background-color: rgb(255,255,255); ">
            <div class="container ">
                ...
                <div class="row ">
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center ">
                        <img src="assets/img/artificial-intelligence.jpg " alt=" " class="img-fluid ">
                    </div>
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center ">
        ...
        <section class="clean-block clean-services dark " style="background-color: rgb(246,246,246); " >
         <div class="container">
                ...
                <div class="row ">
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center d-lg-none "><img class="img-fluid " src="assets/img/artificial-intelligence.jpg "></div>
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center ">
                    ...
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center "><img class="img-fluid d-none d-lg-block " src="assets/img/wwd-whd.jpg "></div>
                </div>
            </div>
        </section>
        <section class="clean-block clean-services dark " style="background-color: rgb(255,255,255); ">
                        ...
                        <div id="demo " class="carousel slide " data-ride="carousel ">
                            <div class="carousel-inner ">
                                <div class="carousel-item active ">
                                    <a href="assets/img/esp32-1.jpg "><img src="assets/img/esp32-1.jpg " alt=" " class="img-fluid "></a>
                                </div>
                                <div class="carousel-item align-items-center ">
                                    <a href="assets/img/esp32-2.jpg "><img src="assets/img/esp32-2.jpg " alt=" " class="img-fluid "></a>
                                </div>
                            </div>
        ...
        <section class="clean-block clean-services dark " style="background-color: rgb(246,246,246); " >
            <div class="container ">
                ...
                <div class="row ">
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center d-lg-none "><img class="img-fluid " src="assets/img/electrical-engineering.jpg "></div>
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center ">
                    ...
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center "><img class="img-fluid d-none d-lg-block " src="assets/img/electrical-engineering.jpg "></div>
                </div>
            </div>
        </section>
        <section class="clean-block clean-services dark " style="background-color: rgb(255,255,255); ">
            <div class="container ">
                ...
                <div class="row ">
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center ">
                        <img src="assets/img/cypress.png " alt=" " class="img-fluid ">
                    </div>
                    <div class="col-md-12 col-lg-6 d-flex flex-wrap align-items-center ">
