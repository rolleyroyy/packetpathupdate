...
<head>
    <meta charset="utf-8">
    <title>Packet Path Blog - Articles by Venkat Subbiah</title>
        ...
        <div class="container" style="padding-top: 0px; margin-bottom: -12px;">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                    <!-- <li class="nav-item" role="presentation"><a class="nav-link " href="http://packetp.com/blog/index.html" style="color: #201D52;"><strong>Home</strong></a></li> -->
...
<div class="highlight"><pre><span></span><code><span class="err">(gdb) target remote …</span></code></pre></div>
...
<p>Cypress does make releases of newer SDK’s quite often and usually doesn’t port fixes to older SDK’s …</p>
...
<h3>WICED Install</h3>
<p>One of the first steps to get started …</p>
