...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/baguettebox.js/1.10.0/baguetteBox.min.css">
      <link rel="stylesheet" href="{{asset('career.css')}}">
...
<!--</div>-->
<div>
<p style="cursor:pointer;color:#007bff"><a href="{{asset('/job1')}}">Read More</a></p>
</div>
</div>
</div>
<div class="p-4">
...
<div>
<p style="cursor:pointer;color:#007bff"><a href="{{asset('/job2')}}">Read More</a></p>
</div>
</div>
</div>
            </div>
