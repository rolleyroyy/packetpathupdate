...
<head>
    ...
    <link href="{{asset('https://fonts.googleapis.com/css2?family=Sanchez&display=swap')}}" rel="stylesheet">
        ...
        <section class="clean-block features" style="margin-top: 50px;">
            <div class="container ">
                ...
                <div class="row">
                    ...
                    <div class="text-center col-lg-4 col-md-12 col-sm-12">
                        <img src="{{asset('img/aiml.jpg')}}" class="img-fluid" />
        ...
        <section class="clean-block slider dark" style="background-color: rgb(255,255,255);">
            <div class="container">
                <div class="customer-logos">
                    ...
                    <div class="slide"><img src="{{asset('img/espressif.jpg')}}"></div>
                    <div class="slide"><img src="{{asset('img/wiced.jpg')}}"></div>
                ...
                <div class="row" style="text-align: center; padding-top: 40px;">
                    <div class="row">
                        <div class="text-center col-lg-6 col-md-12 col-sm-12">
                            <img class="img-fluid" src="{{asset('img/microwave.jpg')}}">
                        ...
                        <div class="text-center col-lg-6 col-md-12 col-sm-12">
                            <img class="img-fluid" src="{{asset('img/air.jpg')}}">
                        ...
                        <div class="text-center col-lg-6 col-md-12 col-sm-12">
                            <img class="img-fluid" src="{{asset('img/alexa.jpg')}}">
